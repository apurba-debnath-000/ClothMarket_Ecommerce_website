...
namespace ClothMarket.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ClothMarketUserManager userManager, ClothMarketSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ClothMarketUser { UserName = model.Email, Email = model.Email, Name = model.Name, Address = model.Address, PhoneNO = model.PhoneNo  };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ClothMarketUser { UserName = model.Email, Email = model.Email };
